...
public class DiamondBrickChest extends BlockContainer
{
    ...
    public final DiamondBrickChest.Type chesttype;
    
    public DiamondBrickChest(String name, float hardness, float resistance, DiamondBrickChest.Type chestTypeIn)
    {
    	super(Material.IRON);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (ilockablecontainer != null)
            {
                ...
                if (this.chesttype == DiamondBrickChest.Type.BASIC)
                {
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityDiamondChest)
            {
                i = ((TileEntityDiamondChest)tileentity).numPlayersUsing;
            }
