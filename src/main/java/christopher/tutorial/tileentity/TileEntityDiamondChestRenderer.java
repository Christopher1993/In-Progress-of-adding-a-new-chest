...
{
	private static final ResourceLocation TEXTURE_DIAMOND_NORMAL = new ResourceLocation("textures/entity/chest/normal.png");
	...
	public void render(TileEntityDiamondChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (te.hasWorld())
        {
            ...
            if (block instanceof DiamondBrickChest && i == 0)
            {
                ((DiamondBrickChest)block).checkForSurroundingChests(te.getWorld(), te.getPos(), te.getWorld().getBlockState(te.getPos()));
                i = te.getBlockMetadata();
            }
        ...
        if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null)
        {
            ...
            if (te.adjacentChestXPos == null && te.adjacentChestZPos == null)
            {
                ...
                {
                    this.bindTexture(TEXTURE_DIAMOND_NORMAL);
                }
            }
