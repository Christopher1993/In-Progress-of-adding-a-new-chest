...
{
	private static final ResourceLocation background = new ResourceLocation("textures/gui/generic_54.png");
	private final IInventory upperChestInventory;
    private final IInventory lowerChestInventory;
    private final int inventoryRows;
    
    public GuiDiamondChest(IInventory upperInv, IInventory lowerInv)
    {
    	super(new ContainerDiamondChest(upperInv, lowerInv, Minecraft.getMinecraft().player));
